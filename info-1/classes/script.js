(function () {
    const classList = [
        ...
        {
            title: "ネットワーク(1) インターネットとプロトコル",
            keyWord: ['ルータ', 'ハブ', 'インターネットサービスプロバイダ', 'LAN', '有線LAN', '無線LAN', 'アクセスポイント', 'Wi-Fi', 'WAN', '5G', '通信プロトコル', 'インターネットプロトコルスイート', 'TCP/IP', 'HTTP', 'TCP', 'IP', 'イーサネット'],
        },
        {
            title: "ネットワーク(2) パケット通信とパリティビット",
            keyWord: ['パケット', 'ヘッダ', '経路制御表(ルーティングテーブル)', '偶数パリティ', '奇数パリティ'],
        },
        {
            title: "ネットワーク(3) 暗号化",
            keyWord: ['情報の盗聴', '暗号化', '平文', '復号', '鍵', 'シーザー暗号', '共通鍵暗号方式', '公開鍵暗号方式'],
        },
    ]
